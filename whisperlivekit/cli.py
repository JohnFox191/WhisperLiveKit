...
BACKENDS = [
    ...
    {
        "id": "qwen3-simul",
        "name": "Qwen3 SimulStreaming",
        "module": "qwen_asr",
        "install": "pip install qwen-asr",
        "description": "Qwen3-ASR with SimulStreaming (AlignAtt) policy",
        "streaming": "native",
        "devices": ["cuda", "mps", "cpu"],
    },
    {
        "id": "qwen3-simul-kv",
        "name": "Qwen3 SimulStreaming+KV",
        "module": "qwen_asr",
        "install": "pip install qwen-asr",
        "description": "Qwen3-ASR with SimulStreaming+KV cache policy",
        "streaming": "native",
        "devices": ["cuda", "mps", "cpu"],
    },
    {
